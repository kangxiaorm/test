...
#
#         # pickup -> its delivery
#         pick_flat = h[:, 0:n_pick, :].contiguous().view(-1, input_dim)  # [batch_size * n_pick, embed_dim]
...
#             attn[:, :, :, graph_size + 1:graph_size + 1 + n_pick].view(self.n_heads, batch_size, graph_size,
#                                                                        n_pick), V_allpick)
#
...
class GraphAttentionEncoder(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        # Batch multiply to get initial embeddings of nodes   h/x: [batch_size, veh_size + graph_size, embed_dim]
