# used after model is completely trained, and test for results_1114_1120
...
from ridesharing.utils import load_model, move_to
from ridesharing.utils.data_utils import save_dataset
from torch.utils.data import DataLoader
import time
from datetime import timedelta
from ridesharing.utils.functions import parse_softmax_temperature
import warnings
...
def eval_dataset(dataset_path, width, softmax_temp, opts):
    # Even with multiprocessing, we load the model here since it contains the name where to write results_1114_1120
    model, _ = load_model(opts.model, opts.obj)
...
def _eval_dataset(model, dataset, width, softmax_temp, opts, device):
    ...
    for batch in tqdm(dataloader, disable=opts.no_progress_bar):
        ...
        for seq, cost, veh_list in zip(sequences, costs, veh_lists):
            if model.problem.NAME in ("ridesharing"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", default=None, help="Name of the results_1114_1120 file to write")
    ...
    parser.add_argument('--results_dir', default='results_1114_1120', help="Name of results_1114_1120 directory")
